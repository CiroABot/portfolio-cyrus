        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-20">
          ...
          <div className="flex-1 w-full">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
                <a href={DOC_LINKS.cv} target="_blank" rel="noreferrer" className="font-mono text-sm font-bold bg-[#333] px-3 py-2 border border-gray-600 hover:bg-white hover:text-black transition-colors interactive-target">
                    ↓ {t.btn_cv}
                </a>
          ...
          <div className="flex flex-col items-start md:items-end gap-4 w-full md:w-auto">
             <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-full md:w-auto text-center bg-white text-black font-bold text-xl px-6 py-2 border-3 border-transparent hover:bg-rose hover:text-white hover:border-white hover:shadow-pop-sm transition-all interactive-target shadow-[4px_4px_0px_#333]">INSTAGRAM</a>
             <a href="https://letterboxd.com" target="_blank" rel="noreferrer" className="w-full md:w-auto text-center bg-white text-black font-bold text-xl px-6 py-2 border-3 border-transparent hover:bg-green-500 hover:text-black hover:border-white hover:shadow-pop-sm transition-all interactive-target shadow-[4px_4px_0px_#333]">LETTERBOXD</a>
             <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="w-full md:w-auto text-center bg-white text-black font-bold text-xl px-6 py-2 border-3 border-transparent hover:bg-yellow hover:text-black hover:border-white hover:shadow-pop-sm transition-all interactive-target shadow-[4px_4px_0px_#333]">LINKEDIN</a>
             <a href={t.blog_url} target="_blank" rel="noreferrer" className="w-full md:w-auto text-center bg-white text-black font-bold text-xl px-6 py-2 border-3 border-transparent hover:bg-navy hover:text-white hover:border-white hover:shadow-pop-sm transition-all interactive-target shadow-[4px_4px_0px_#333]">SUBSTACK</a>
